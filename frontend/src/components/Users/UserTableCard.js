    ...
    <tr className="">
      <td className="py-3">
        <div className="flex items-center justify-center">
          {img && img.length ? <div className="w-12 h-12 rounded-full bg-secondary-500" style={styleObj}></div> : <FaUserAlt/>}
        </div>
      </td>
      <td className="py-3">
        <div className="flex items-center justify-center">
      ...
      <td className="py-3">
        <div className="flex items-center justify-center gap-3 text-secondary-200">
          <button><MdOutlineEdit className="w-6 h-6"/></button>
          <button><MdDeleteOutline className="w-6 h-6"/></button>
        </div>
      </td>
    </tr>
  );
